...
class UsersRegister(models.Model):
    ...
    password = models.CharField(max_length=255, null=True, blank=True, help_text="User's password")  # Increased to 255
    confirm_password = models.CharField(max_length=255, null=True, blank=True, help_text="Confirm user's password")  # Increased to 255
